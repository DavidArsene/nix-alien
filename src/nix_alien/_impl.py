...
def main(
    ...
    parser.add_argument(
        "-r",
        "--recreate",
        help="Recreate 'flake.nix' file if exists",
        action="store_true",
    )
    parser.add_argument(
        "-d",
        "--destination",
        metavar="PATH",
        help="Path where 'flake.nix' file will be created",
    )
    parser.add_argument(
        "-P",
        "--print-destination",
        help="Print where 'flake.nix' file is located and exit",
        action="store_true",
    )
    parser.add_argument(
        "-E",
        "--edit",
        help="Edit 'flake.nix' using $EDITOR (or 'nano' if unset)",
        action="store_true",
    )
    parser.add_argument(
        "-s",
